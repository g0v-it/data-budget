<?php
/**
 * Gateway per trasformare  un rendiconto di bilancio emesse dal 2017 su BDAP
...
//ARRAY FOR VALUES
$a = "amministrazione"; $m = "missione"; $p = "programma"; $az = "azione"; $c = "capitolo"; $b = "record";
$match = array(
    $a => 2,
    $m => 13,
    $p => 15,
...
//TAXONOMY
echo"
$taxonomyUri a g0v:RecordTaxonomy, skos:ConceptScheme;
...
function printBudget($uri, $subjectUri, $subjectLabel, $value){
    ...
    printf("%s a g0v:Record, qb:Observation ;
        g0v:subject %s ;
        qb:dataSet  <%s>;
