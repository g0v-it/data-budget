...
$c = "capitolo";
$b = "fact";
include "csv_schema_{$argv[2]}.php";
...
while ($rawdata = fgetcsv(STDIN, 2048, ';')) {
    ...
    if ($firstRecord) {
        // write some metadata about the dataset and taxonomy
        
        echo"
resource:$bdapDatasetId a g0v:FinancialReport;
    g0v:refPeriod <http://reference.data.gov.uk/id/gregorian-interval/{$esercizio}-01-01T00:00:00/P1Y> ;  
...
$taxonomyUri a skos:ConceptScheme;
    ...
    dct:description \"Tassonomia per amministrazioni>missioni>programmi>azioni>capitoli esercizio {$esercizio}\"@it
.
";
        $firstRecord =false;
    }
